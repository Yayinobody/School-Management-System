...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/students/profile/{student}', [StudentController::class, 'show'])->name('showStudent');
    ...
    Route::delete('/students/destroy/{student}', [StudentController::class, 'destroy'])->name('deleteStudent');
